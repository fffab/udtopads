 ...
 */
/**
 * banner - categories relation edit block
 *
 * @category    Unideal
 * @package     Unideal_Topads
 * @author      Ultimate Module Creator
 */
class Unideal_Topads_Block_Adminhtml_Banner_Edit_Tab_Categories
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('unideal_topads/banner/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }
    /**
     * Retrieve currently edited banner
     * @access public
    ...
    /**
     * Return array with categories IDs which the banner is linked to
     * @access public
     * @return array
     * @author Ultimate Module Creator
     */
    public function getCategoryIds(){
        if (is_null($this->_categoryIds)){
            $categories = $this->getBanner()->getSelectedCategories();
                $ids = array();
     ...
     * Returns root node
     *
     * @param Unideal_Topads_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current banner)
     *
     * @return array
     */
