 ...
 */
/**
 * Banner - product relation edit block
 *
 * @category    Unideal
 * @package     Unideal_Topads
 * @author      Ultimate Module Creator
 */
class Unideal_Topads_Block_Adminhtml_Banner_Edit_Tab_Product
     ...
     * @access protected
     * @return Unideal_Topads_Block_Adminhtml_Banner_Edit_Tab_Product
     * @author Ultimate Module Creator
     */
     ...
     * get row url
     * @access public
     * @param Unideal_Topads_Model_Product
     * @return string
     * @author Ultimate Module Creator
     */
