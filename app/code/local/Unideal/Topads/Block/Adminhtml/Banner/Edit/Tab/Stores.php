 ...
 */
class Unideal_Topads_Block_Adminhtml_Banner_Edit_Tab_Stores
    extends Mage_Adminhtml_Block_Widget_Form {
    /**
     * prepare the form
     * @access protected
     * @return Unideal_Topads_Block_Adminhtml_Banner_Edit_Tab_Stores
     * @author Ultimate Module Creator
     */
    protected function _prepareForm(){
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('banner_stores_form', array('legend'=>Mage::helper('unideal_topads')->__('Store views')));
