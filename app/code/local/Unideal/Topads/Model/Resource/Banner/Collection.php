...
class Unideal_Topads_Model_Resource_Banner_Collection
    ...
    public function addProductFilter($product){
        ...
        if (!isset($this->_joinedFields['product'])){
            $this->getSelect()->join(
                array('related_product' => $this->getTable('unideal_topads/banner_product')),
                'related_product.banner_id = main_table.entity_id',
                array('position')
            );
    ...
    public function addCategoryFilter($category){
        ...
        if (!isset($this->_joinedFields['category'])){
            $this->getSelect()->join(
                array('related_category' => $this->getTable('unideal_topads/banner_category')),
                'related_category.banner_id = main_table.entity_id',
                array('position')
            );
